...
export default function FranchiseModels() {
    return (
        <div className="min-h-screen bg-gray-100 flex flex-col items-center justify-center p-6">
            ...
            <div className="grid md:grid-cols-2 gap-6 max-w-5xl">
                ...
                <div className="hover:scale-110 transition-all bg-white p-6 rounded-2xl shadow-lg border border-gray-200">
                    <div className="flex items-start gap-4">
                        ...
                        <div>
                            <h3 className="text-xl font-semibold text-gray-900">MedU by ShopU</h3>
                ...
                <div className="space-y-4 ml-6">
                    <div className="hover:scale-110 bg-white p-4 rounded-xl shadow-md hover:shadow-lg transition">
                        <h4 className="text-lg font-semibold text-gray-900">ShopU Store</h4>
                    ...
                    <div className="hover:scale-110 bg-white p-4 rounded-xl shadow-md hover:shadow-lg transition">
                        <h4 className="text-lg font-semibold text-gray-900">ShopU Mart</h4>
                    ...
                    <div className="hover:scale-110 bg-white p-4 rounded-xl shadow-md hover:shadow-lg transition">
                        <h4 className="text-lg font-semibold text-gray-900">ShopU Super Mart</h4>
            ...
            {/* Apply Button */}
            <button className="mt-8 bg-green-600 text-white px-6 py-3 rounded-xl shadow-lg hover:bg-green-700 transition">
                Apply for Franchise
            </button>
        </div>
    );
